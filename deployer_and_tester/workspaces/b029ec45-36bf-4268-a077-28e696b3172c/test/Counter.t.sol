...
contract CounterTest is Test {
    ...
    function testAfterSwap() public {
        ...
        BalanceDelta balanceDelta = BalanceDelta(1000, -1000);
        bytes memory hookData = bytes("");
    ...
    function testBeforeAddLiquidity() public {
        ...
        bytes4 selector = counter._beforeAddLiquidity(address(this), poolKey, liquidityParams, hookData);
    ...
    function testBeforeRemoveLiquidity() public {
        ...
        bytes4 selector = counter._beforeRemoveLiquidity(address(this), poolKey, liquidityParams, hookData);
