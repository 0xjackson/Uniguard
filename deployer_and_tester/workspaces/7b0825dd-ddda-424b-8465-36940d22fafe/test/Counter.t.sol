...
contract CounterTest is Test {
    ...
    function testBeforeSwap() public {
        ...
        bytes4 selector = counter._beforeSwap(address(this), poolKey, swapParams, bytes(""));
        assertEq(selector, Counter.beforeSwap.selector);
    ...
    function testAfterSwap() public {
        ...
        bytes4 selector = counter._afterSwap(address(this), poolKey, swapParams, balanceDelta, bytes(""));
        assertEq(selector, Counter.afterSwap.selector);
    ...
    function testBeforeAddLiquidity() public {
        ...
        bytes4 selector = counter._beforeAddLiquidity(address(this), poolKey, liquidityParams, bytes(""));
        assertEq(selector, Counter.beforeAddLiquidity.selector);
    ...
    function testBeforeRemoveLiquidity() public {
        ...
        bytes4 selector = counter._beforeRemoveLiquidity(address(this), poolKey, liquidityParams, bytes(""));
        assertEq(selector, Counter.beforeRemoveLiquidity.selector);
