...
contract CounterTest is Test {
    ...
    function testBeforeSwap() public {
        ...
        (bytes4 selector, BeforeSwapDelta memory delta, uint24 fee) = counter._beforeSwap(address(this), poolKey, swapParams, data);
    ...
    function testAfterSwap() public {
        ...
        BalanceDelta memory balanceDelta = BalanceDelta(100, 200);
        bytes memory data = "";

        (bytes4 selector, int128 fee) = counter._afterSwap(address(this), poolKey, swapParams, balanceDelta, data);
    ...
    function testBeforeAddLiquidity() public {
        ...
        bytes4 selector = counter._beforeAddLiquidity(address(this), poolKey, liquidityParams, data);
    ...
    function testBeforeRemoveLiquidity() public {
        ...
        bytes4 selector = counter._beforeRemoveLiquidity(address(this), poolKey, liquidityParams, data);
